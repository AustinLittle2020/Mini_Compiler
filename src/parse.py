...
class Parser:
    ...
    def nextToken(self):
        ...
        # Don't worry about passing the EOF, lexer handles it
    ...
    def program(self):
        ...
        # Since some newlines are required in our languages grammar, need to skip the excess
    ...
    def statement(self):
        ...
        # "INPUT" ident
            ...
            self.match(TokenType.IDENT)
        # This is not a valid statement, throw error
        else:
